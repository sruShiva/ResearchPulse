...
class StudentPersona:
    ...
    def answer_query_graph(self,query):
        ...
        try:
            ...
            You are a research analyser who is helping students with research opportunities from that institution.
            Your task is to answer the given query for a student based on research opportunities in Europe.
